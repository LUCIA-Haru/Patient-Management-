...
import com.pm.api_gateway.response.ApiResponse;
import com.pm.api_gateway.utils.constants.Commons;
import com.pm.api_gateway.utils.message.ErrorMessageUtils;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Object>> handleUserNotFoundException(
        ...
        String message = ErrorMessageUtils.NOT_FOUND.formatted(Commons.USER + ex.getMessage());
        log.warn(message + " - " + ex.getMessage());
        ApiResponse<Object> response = new ApiResponse<>(
                "error",
                HttpStatus.BAD_REQUEST.value(),
